...
export default function Faq() {
    return (
        <div id="Faq">
            <section className="faq mt-5 mb-3 " id="faq">
                <div className="container ">
                    ...
                    <div className="col col-lg-6 mb-5">
                        ...
                        <div className="accordion-item mt-3">
                            ...
                            <button className="accordion-button collapsed fw-bold fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                        ...
                        <div className="accordion-item mt-3">
                            ...
                            <button className="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseThree">
